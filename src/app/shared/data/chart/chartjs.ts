...
export var barChartData: any[] = [
  ...
  { data: [35, 59, 80, 81, 56, 55, 40], label: 'Series B' }
];
...
export var lineGraphColors: Array<any> = [
  ...
  {
    backgroundColor: 'rgba(21, 141, 247, 0.5)',
    borderColor: "#158df7",
    borderWidth: 2,
  },
];
...
export var lineChartColors: Array<any> = [
  ...
  {
    backgroundColor: 'rgba(84, 79, 255, 0.3)',
    borderColor: "#544fff",
    borderWidth: 2,
    lineTension: 0,
  },
  {
    backgroundColor: 'rgba(253, 81, 125, 0.3)',
    borderColor: "#fd517d",
    borderWidth: 2,
    lineTension: 0,
  }
...
export var doughnutChartColors: any[] = [{ backgroundColor: ["#158df7", "#544fff", "#fb2e63"] }];
...
export var ploarChartColors: any[] = [{ backgroundColor: ["#158df7", "#544fff", "#51bb25", "#007bff", "#fb2e63"] }];
