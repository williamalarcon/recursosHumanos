    ...
    static ticket = [
        {
            ...
            salary: "$320,800",
            office: "Edinburgh",
            skill: "<div class='progress-showcase'><div class='progress sm-progress-bar' style='width:70%'><div class='progress-bar custom-progress-width bg-danger' role='progressbar'></div></div></div>",
            extn: 5421,
